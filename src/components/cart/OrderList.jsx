...
export class OrderList extends Component {
  render() {
    return (
             ...
             <Row className="justify-content-center">
                  <Col lg={6} md={6} sm={12}  >
                       <ul className="list-group">
                            <li className="list-group-item">Name :  RIA </li>
                            <li className="list-group-item">Email :  test@gmail.com </li>
                       </ul>
                  </Col>
             </Row>
        </Container>
        ...
        <Container >
             <div className="text-center mb-55"><h2> order history by(Nizar ) </h2>
             </div>
             <Card >
                  <Card.Body>
